...
```json
{
  ...
  "paddleocr_doc_parsing_api_url": "https://your-host.aistudio-app.com/layout-parsing",
...
```bash
export PADDLEOCR_DOC_PARSING_API_URL="https://xxx.aistudio-app.com/layout-parsing"
